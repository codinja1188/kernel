...
extern int  mxs_spi_fpc1080_pin_init(void);
extern int mxs_spi_fpc1080_pin_release(void);
extern int  mxs_spi_spidev_pin_init(void);
extern int mxs_spi_spidev_pin_release(void);
extern int msg2133_pin_init(void);
extern int msg2133_pin_release(void);
